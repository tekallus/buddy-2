...
export default function app() {
  const [flashCard, setFlashCard] = useState({
    ...
    explanation: `Birinin framework diyebilme cüretini gösterdiğini duyarsanız, onu mümkün olduğunca bilgili bir şekilde düzeltmeniz, tercihen yanıtınıza " aslında..." başlamanız önemlidir.`
  });
...
*/
  ...
  const handleFlashCardClick = () => {
    // Flashcard'a tıklandığında isFlipped durumunu tersine çevir
